  ...
  <body>
    ...
    <section id="populer" class="isi">
      <div class="container">
        <div class="list-group">
          <a href="../bantuan/bantuan.php"><button type="button" class="list-group-item list-group-item-action active" aria-current="true">Populer</button></a>
          <a href="../bantuan/kartuhelp.php"><button type="button" class="list-group-item list-group-item-action">Kartu</button></a>
          <a href="../bantuan/layanan.php"><button type="button" class="list-group-item list-group-item-action">Layanan</button></a>
          <a href="../bantuan/pulsahelp.php"><button type="button" class="list-group-item list-group-item-action">Pulsa</button></a>
          <a href="../bantuan/jaringan.php"><button type="button" class="list-group-item list-group-item-action">Jaringan</button></a>
        </div>
      </div>
    </section>
    ...
    <section class="isikanan" id="populer">
      <div class="list-group">
        ...
        <button type="button" class="list-group-item list-group-item-action">Bagaimana Mengatasi Kendala Pulsa Tidak Masuk<i class="bx bxs-chevron-right" style="margin-left: 378px"></i></button>
      </div>
    </section>
    ...
    <section class="komentar">
      <div class="container">
        <h4 style="text-align: center; padding-bottom: 50px">Komentar</h4>
        <div class="row">
