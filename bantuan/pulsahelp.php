  ...
  <section id="populer" class="isi">
    <div class="container">
      <div class="list-group">
        <a href="bantuan.html"><button type="button" class="list-group-item list-group-item-action" aria-current="true">Populer</button></a>
        <a href="kartuhelp.html"><button type="button" class="list-group-item list-group-item-action">Kartu</button></a>
        <a href="layanan.html"><button type="button" class="list-group-item list-group-item-action">Layanan</button></a>
        <a href="pulsahelp.html"><button type="button" class="list-group-item list-group-item-action active">Pulsa</button></a>
        <a href="jaringan.html"><button type="button" class="list-group-item list-group-item-action">Jaringan</button></a>
      </div>
    </div>
  </section>
...
height: 10vh;">
    <h6> <span style="text-align: left; color: white; margin-left: 80px; padding-right: 530px;">Copyright @Aero Cell, 2023</span>
      <span style="text-align: right; color: white;">Kebijakan Privasi &nbsp; | &nbsp;Syarat & Ketentuan</span>
    </h6>
  </div>
