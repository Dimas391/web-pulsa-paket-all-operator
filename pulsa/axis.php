...
<body>
    ...
    <div class="container">
      ...
      <div class="row mx-5">
        <div class="card col-md-2" style="width: 16rem;">
          <img src="../assets/img/logo/Axis_logo.png" alt="...">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <ul class="navbar-nav">
            ...
            <li><a class="nav-link active text-primary" href="axis.php">Axis</a></li>
  ...
  <?php
  $query = "SELECT * FROM products_pulsa WHERE  Jenis_pulsa LIKE '%Axis%'";
