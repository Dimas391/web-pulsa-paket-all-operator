...
<body>
    ...
    <div class="container">
      ...
      <div class="row mx-5">
        <div class="card col-md-2" style="width: 16rem;">
          <img src="../assets//img//logo//Byu-logo-blue.svg.png" alt="...">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <ul class="navbar-nav">
            ...
            <li><a class="nav-link active text-primary" href="byu.php">By.U</a></li>
  ...
  <?php
  $query = "SELECT * FROM products_pulsa WHERE Jenis_pulsa='By.U'";
