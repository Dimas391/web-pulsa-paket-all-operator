...
$query = mysqli_query($koneksi, "SELECT * FROM products_paket_xl");
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="container-fluid" <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav d-flex flex-column gap-3 py-3">
                        ...
                        <div class="collapse" id="collapseExample">
                            ...
                            <li>
                                <a class="nav-link active fw-bold" href="products-xl.php" style="margin-top: -11px; margin-left: 6px; color: grey">XL</a>
                            </li>
                            <li>
            ...
            <div class="col-lg-10 p-4" style="margin-top: 70px;">
                <h5 style="font-weight: bold">Halaman Products Paket XL</h5>
                <div class="row">
                        ...
                        <table id="myTable" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Kuota Aplikasi</th>
                                    <th scope="col">Kuota Area</th>
                                    <th scope="col">Kuota Nelpon</th>
                                    <th scope="col">Kuota Sosmed</th>
                                    <th scope="col">Kuota Pribadi</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td width="30%"><?php echo $row['Kuota_aplikasi'] ?></td>
                                        <td width="30%"><?php echo $row['Kuota_area'] ?></td>
                                        <td width="30%"><?php echo $row['Kuota_Nelpon'] ?></td>
                                        <td width="30%"><?php echo $row['Kuota_sosmed'] ?></td>
                                        <td width="30%"><?php echo $row['Kuota_pribadi'] ?></td>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Data Produk Paket XL</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form action="proses-input-xl.php" method="POST">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInput1" name="Kuota_utama">
                                    </div>

                                    <div class="mb-3">
                                        <label for="exampleFormControlInput3" class="form-label">Kuota Aplikasi</label>
                                        <input type="text" class="form-control" id="exampleFormControlInput1" name="Kuota_aplikasi">
                                    </div>

                                    <div class="mb-3">
                                        <label for="exampleFormControlInput3" class="form-label">Kuota Area</label>
                                        <input type="text" class="form-control" id="exampleFormControlInput1" name="Kuota_area">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput3" class="form-label">Kuota Pribadi</label>
                                        <input type="text" class="form-control" id="exampleFormControlInput1" name="Kuota_pribadi">
                                    </div>
                ...
                ?>
                    <div class="modal fade" id="exampleModal1<?php echo $row['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Detail data Produk XL</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form action="proses-input-axis.php" method="POST">
                                        ...
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput3" class="form-label">Kuota Aplikasi</label>
                                            <input type="text" class="form-control" id="exampleFormControlInput1" name="Kuota_aplikasi" value="<?php echo $row['Kuota_aplikasi']; ?>" disabled>
                                        </div>

                                        <div class="mb-3">
                                            <label for="exampleFormControlInput3" class="form-label">Kuota Area</label>
                                            <input type="text" class="form-control" id="exampleFormControlInput1" name="Kuota_area" value="<?php echo $row['Kuota_area']; ?>" disabled>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput3" class="form-label">Kuota Pribadi</label>
                                            <input type="text" class="form-control" id="exampleFormControlInput1" name="Kuota_pribadi" value="<?php echo $row['Kuota_pribadi']; ?>" disabled>
                                        </div>
        ...
        ?>
            <div class="modal fade" id="exampleModalupdate<?php echo $row['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Update Data Produk XL</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form action="proses-update-xl.php" method="POST">
                                ...
                                <div class="mb-3">
                                    <label for="exampleFormControlInput2" class="form-label">Kuota Utama</label>
                                    <input type="text" class="form-control" id="exampleFormControlInput1" name="Kuota_utama" value="<?php echo $row['Kuota_utama']; ?>">
                                </div>

                                <div class="mb-3">
                                    <label for="exampleFormControlInput3" class="form-label">Kuota Aplikasi</label>
                                    <input type="text" class="form-control" id="exampleFormControlInput1" name="Kuota_aplikasi" value="<?php echo $row['Kuota_aplikasi']; ?>">
                                </div>

                                <div class="mb-3">
                                    <label for="exampleFormControlInput3" class="form-label">Kuota Area</label>
                                    <input type="text" class="form-control" id="exampleFormControlInput1" name="Kuota_area" value="<?php echo $row['Kuota_area']; ?>">
                                </div>
                                ...
                                <div class="mb-3">
                                    <label for="exampleFormControlInput3" class="form-label">Kuota Pribadi</label>
                                    <input type="text" class="form-control" id="exampleFormControlInput1" name="Kuota_pribadi" value="<?php echo $row['Kuota_pribadi']; ?>">
                                </div>
            ...
            <div class="modal fade" id="exampleModaldelete<?php echo $row['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="proses-delete-xl.php" method="POST">
                                <input type="hidden" value="<?php echo $row['id'] ?>" name="id">
                                <div class="col-lg-12">
