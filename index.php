...
$welcome_message = "Selamat datang, $username!"; // Ganti dengan pesan yang sesuai
?>
</style>
<!DOCTYPE html>
<html lang="en">
  ...
  <nav>
    <div class="navbar">
      ...
      <div class="nav-links">
        ...
        <ul class="links">
          <li><a href="index.html" style="font-family: italic">Beranda</a></li>
          <li><a href="pulsa.php" style="font-family: italic">Pulsa</a></li>
          <li>
            <a href="#" style="font-family: italic">Produk & Paket</a>
            <i class='bx bxs-chevron-down htmlcss-arrow arrow'></i>
            <ul class="htmlCss-sub-menu sub-menu">
              <li><a href="/product dan paket/produktelkomsel.html"  style="font-family: italic">Telkomsel</a>
              <a href="/product dan paket/produkaxis.html" style="font-family: italic">Axis</a>
              <a href="/product dan paket/produkindoosat.html" style="font-family: italic">Indoosat</a>
              <a href="/product dan paket/produkxl.html" style="font-family: italic">XL</a>
              <a href="/product dan paket/produkbyu.html" style="font-family: italic">By.u</a>
              <a href="/product dan paket/produksmartfren.html" style="font-family: italic">Smartfren</a></li>
            </ul>
          </li>
          <li>
      ...
      <div class="header">
      <button class="btn btn-primary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false" class="btn btn-primary"><?= $username ?></button>
      <ul class="dropdown-menu dropdown-menu-end">
      <li><a class="dropdown-item" href="#" style="font-family: italic">Profile</a></li>
      <li><a class="dropdown-item" href="#" style="font-family: italic">Another action</a></li>
  ...
  <div class="row mt-4">
    ...
    <div class="col-lg-2 col-sm-4 mt-3">
      <div class="pKanan">
        ...
        <br><p style="font-family: italic">Beli Kartu Perdana</p>
      </div>
    </div>
    <div class="col-lg-2 col-sm-4 mt-3">
      <div class="pKanan">
        ...
        <br><p style="font-family: italic">Isi Ulang Pulsa</p>
      </div>
    </div>
    <div class="col-lg-2 col-sm-4 mt-3">
      <div class="pKanan">
        ...
        <br><p style="font-family: italic">Beli Paket</p>
      </div>
    </div>
  </div>
</div>
...
<footer>
  ...
  <div data-aos="fade-right">
      ...
      <div class="col-lg-4 col-sm-8">
        ...
        <a href="/bantuan/bantuan.html" class="btn btn-primary" style="font-family: italic">Hubungi Kami</a>
        </div>
        </div>
    </div>
  </div>
...
height: 10vh;">
  <h6> <span style="text-align: left; color: white; margin-left: 80px; padding-right: 530px; font-style: italic;">Copyright @Aero Cell, 2023</span>
   <span style="text-align: right; color: white; font-style: italic;">Kebijakan Privasi &nbsp; | &nbsp;Syarat & Ketentuan</span></h6>
</div>
