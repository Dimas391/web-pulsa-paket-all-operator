...
<html>
  <head>
    <title>Registrasi Aero Cell</title>
      ...
      <div class="login-content">
        <form action="proses-register.php" method="POST">
          <svg class="pp" id="457bf273-24a3-4fd8-a857-e9b918267d6a" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="698" height="698" viewBox="0 0 698 698">
            ...
            <g opacity="0.5"><circle cx="349" cy="349" r="349" fill="url(#b247946c-c62f-4d08-994a-4c3d64e1e98f)" /></g>
          ...
          <div class="input-div pass">
            ...
            <div class="div">
              <input type="password" id="password1" class="input" name="password"  placeholder="Password" required/>
          ...
          <div class="input-div pass">
            ...
            <div class="div">
              <input type="password" id="password2" name="password2" class="input"  placeholder="Ulangi Password" required/>
