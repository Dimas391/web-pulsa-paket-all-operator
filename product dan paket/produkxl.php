  ...
  <section id="collection" class="py-5">
    <div class="container">
      <div class="title text-center">
        <h2 class="position-relative d-inline-block">Paket XL</h2>
      </div>
      <?php
      $query = "SELECT * FROM products_paket_xl";
          ...
          <div class="modal fade" id="exampleModal<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="../Pembayaran/proses-pembayaran-xl.php" method="POST">
                  <input type="hidden" value="<?php echo $row['id'] ?>" name="id">
                  <div class="modal-body">
                    <div class="card">
                      <div class="card-body">
                        <p class="card-title"><?php echo $row['Nama_produk'] ?></p>
                        <p><?php echo $row['Kuota_utama'] ?></p>
                        <p><?php echo $row['Kuota_aplikasi'] ?></p>
                        <p><?php echo $row['Kuota_area'] ?></p>
                        <p><?php echo $row['Kuota_pribadi'] ?></p>
                        <p><?php echo $row['Kuota_Nelpon'] ?></p>
                        <p><?php echo $row['Kuota_sosmed'] ?></p>
                        <br />
                        <h3 class="akhir">Rp.<?php echo $row['Harga'] ?></h3>
                      </div>
                    </div>
