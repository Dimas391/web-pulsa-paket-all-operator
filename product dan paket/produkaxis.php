...
<style>
  ...
  .filter-button-group .btn-tombol-beli:hover {
    color: #fff !important;
  }
  ...
  <section id="collection" class="py-5">
    <div class="container">
      <div class="title text-center">
        <h2 class="position-relative d-inline-block">Paket Axis</h2>
      </div>

      <?php
      $query = "SELECT * FROM products_paket_axis";
          ...
          <div class="modal fade" id="exampleModal<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="../Pembayaran/proses-pembayaran-axis.php" method="POST">
                  ...
                  <div class="modal-body">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <h6><?php echo $row['Kuota_malam'] ?></h6>
                        <h6><?php echo $row['Kuota_video'] ?></h6>
                        <h6><?php echo $row['Kuota_sosmed'] ?></h6>
                        <h6><?php echo $row['Kuota_game'] ?></h6>
                        <br />
                        <h3 class="akhir">Rp. <?php echo $row['Harga'] ?></h3>
                      </div>
                    </div>
