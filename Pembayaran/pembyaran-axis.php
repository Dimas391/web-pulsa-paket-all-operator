                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3" style="position:absolute; width: 400px; margin-left: 620px; margin-top: -580px; background-color:#eee; padding: 10px; height:">
                                <?php if (!empty($_SESSION["keranjang"])) : ?>
                                    <?php foreach ($_SESSION["keranjang"] as $id_paket_axis => $jumlah) : ?>
                                        <?php
                                        $ambil = $koneksi->query("SELECT * FROM penjualan INNER JOIN products_paket_axis ON penjualan.id_paket_axis = products_paket_axis.id WHERE penjualan.id_paket_axis = '$id_paket_axis'");
