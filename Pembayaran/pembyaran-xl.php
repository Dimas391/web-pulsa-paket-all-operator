                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3" style="position:absolute; width: 400px; margin-left: 620px; margin-top: -580px; background-color:#eee; padding: 10px; height:">
                                <?php if (!empty($_SESSION["keranjang"])) : ?>
                                    <?php foreach ($_SESSION["keranjang"] as $id_paket_xl => $jumlah) : ?>
                                        <?php
                                        $ambil = $koneksi->query("SELECT * FROM penjualan INNER JOIN products_paket_xl ON penjualan.id_paket_xl = products_paket_xl.id WHERE penjualan.id_paket_xl = '$id_paket_xl'");
